...
public class KeyshaMoralesQuiros_Tarea3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int montoBecaAcademica=50000,montoBecaDeportiva=80000, noBecados=0, cantEstBecaDeportiva=0,cantEstBecaAcademica=0,becados,estudianteNivel, equipo, baloncesto=0, natacion=0, ajedrez=0, sinEquipo=0, nivel1=0, nivel2=0, nivel3=0, nivel4=0, nivel5=0;
        
        double  i=1, cantEstudiantes=0, porcentajeBecados, porcentajeNoBecados, montoTotalMensualBecaAcademica, montoTotalAnualBecaAcademica, montoTotalMensualBecaDeportiva, montoTotalAnualBecaDeportiva ;
        
        out.println("Ingrese la cantidad de estudiantes a realizar la encuesta");
